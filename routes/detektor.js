...
router.route('/getpotholes')
        .get(function(req,res){
                db.getpotholes(req, res);
        });

router.route('/getallpotholes')
        .get(function(req,res){
                db.getallpotholes(req, res);
        });

router.route('/getclusters')
        .get(function(req,res){
                db.getclusters(req, res);
        });

router.route('/calcpotholes')
        .get(function(req,res){
                db.calcpotholes(req, res);
        });

router.route('/getrashdriving')
        .get(function(req,res){
                db.getrashdriving(req, res);
        });

router.route('/saveclusters')
        .post(function(req,res){
